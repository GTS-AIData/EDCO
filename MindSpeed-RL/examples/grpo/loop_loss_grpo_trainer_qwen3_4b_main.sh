...
export task_name="$1"
export MASTER_ADDR="${2:-10.50.89.131}"
export pretrain_ckpt="${3:/home/Qwen3/model_weight/Qwen3-4B-mcore-TP8PP1}"
export date="1017"
...
export CKPT_LOAD_DIR="/home/Qwen3/model_weight/pre_train_wl_100/"
