...
TRAIN_CONFIG_NAME=grpo_qwen3_4B_A3_${task_name}
# ✅ 将配置文件保存在任务目录下，长期保留
...
# ========== 第二步：生成训练配置 ==========
python ./cli/generate_temp_config.py \
  configs/grpo_qwen3_4b_A3_loop.yaml \
  "$TRAIN_CONFIG_YAML"
...
bash ./examples/grpo/grpo_trainer_qwen3_4b_loop.sh "${TRAIN_CONFIG_NAME}" "${MASTER_ADDR}"
