...
export model_path="/home/Qwen3/Model/Qwen3-8B/"
export CKPT_LOAD_DIR="/home/Qwen3/model_weight/Qwen3-8B-mcore-TP8PP1"
...
TRAIN_CONFIG_NAME=grpo_qwen3_8B_A3_${task_name}
# ✅ 将配置文件保存在任务目录下，长期保留
...
# ========== 第二步：生成训练配置 ==========
python ./cli/generate_temp_config.py \
  configs/grpo_qwen3_8b_A3_loop.yaml \
  "$TRAIN_CONFIG_YAML"
...
bash ./examples/grpo/grpo_trainer_qwen3_8b_loop.sh "${TRAIN_CONFIG_NAME}"
